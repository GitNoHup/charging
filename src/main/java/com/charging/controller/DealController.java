...
public class DealController {
    ...
    public static List<UnitDto> unitDtos = new ArrayList<>();
    ...
    public void importPreview(@RequestParam("file") MultipartFile file,HttpServletResponse httpServletResponse) {
        unitDtos = ExcelUtil.importExcel(file, 1, 1, UnitDto.class);
        ...
        //ExcelUtil.exportExcel(unitDtos,"123","",UnitDto.class,"结算单价.xls",httpServletResponse);
    }

    @RequestMapping(value="export")
    public void importPreview(HttpServletResponse httpServletResponse) {
